...
async def main_page(request: Request):  # Переименовали функцию
    return templates.TemplateResponse(
        "started_page.html",  # Используем правильный разделитель
        {"request": request},
    )


@app.get("/login", response_class=HTMLResponse)  # Изменили эндпоинт
async def login_page(request: Request):  # Переименовали функцию
    return templates.TemplateResponse(
        "login_page.html",  # Используем правильный разделитель
        {"request": request},
    )
